...
defineKnownQuantity(70, 'y', '| human life times');
defineKnownQuantity(100, 'y', '| centuries');
defineKnownQuantity(507, 'y', '| \xD7 the longevity of the Roman Empire');
defineKnownQuantity(623, 'y', '| \xD7 the longevity of the Ottoman Empire');
...
defineKnownQuantity(0.6, 'oz', '| Eurasian water shrews');
...
defineKnownQuantity(4.5, 'kg', '| adult house cats');
defineKnownQuantity(70, 'lb', '| adult male golden retrievers');
defineKnownQuantity(155, 'kg', '| lions');
defineKnownQuantity(480, 'lb', '| male Bengal tigers');
defineKnownQuantity(345, 'kg', '| grand pianos');
defineKnownQuantity(650, 'kg', '| cows');
defineKnownQuantity(600, 'lb', '| inland male grizzly bears');
defineKnownQuantity(800, 'lb', '| male Large White pigs');
defineKnownQuantity(2754, 'lb', '| 2014 Honda Civic LXs');
defineKnownQuantity(1750, 'kg', '| rhinos');
defineKnownQuantity(13000, 'lb', '| African bush elephants');
defineKnownQuantity(8000, 'lb', '| male Killer Whales');
